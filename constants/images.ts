const images = {
  ...
  panelHeader: require('../assets/newAssets/panel_header.png'),
  panel: require('../assets/newAssets/panel.png'),
  normalButton: require('../assets/newAssets/button_normal.png'),
  adButton: require('../assets/newAssets/button_ad.png'),
